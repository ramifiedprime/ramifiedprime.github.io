...
\end{proof}
\begin{corollary}\label{cor:additivity}
Assume that $(a,b_1)_v=(a,b_2)_v=+1$ and $(a_1,b)_v=(a_2,b)_v=+1$ for all places $v$, then 
    \begin{align*}
...
\begin{proof}
    ...
    \textbf{Final idea:}  Apply bonus repeated Cauchy--Schwarz on the inner sum, applying additivity of our $\phi^{\fG}$ from \Cref{cor:additivity}, to bound it by

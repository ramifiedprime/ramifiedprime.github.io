...
given by $(e_1,\dots,e_r)\mapsto \prod_{i=1}^r\chi_{p^*}^{e_i}$.  Again this is surjective with kernel $(1,\dots,1)$ as before.  Note that in fact this $\psi$ naturally factors as the restriction to $G_K$ of a natural map

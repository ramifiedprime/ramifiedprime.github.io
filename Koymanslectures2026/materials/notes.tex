...
\[\abs{\sum_{x\in Y}\widetilde{\Art_{x,2}}(\bv_i,\bw_j)}=o(\#Y)=o(H),\]
...
\[\abs{\sum_{x\in Y}\widetilde{\Art_{x,2}}(\bv_{i},\bw_j)\widetilde{\Art_{x,2}}(\bv_k,\bw_{\ell})}=o(H).\]
...
\[\abs{\sum_{x\in Y}\prod_{i=1}^t\prod_{j=1}^t\widetilde{\Art_{x,2}}(\bv_{i},\bw_j)^{\eta(i,j)}}=o(H).\]
